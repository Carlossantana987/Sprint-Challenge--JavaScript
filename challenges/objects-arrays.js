...
const animalNames = zooAnimals.forEach((i) => {
  console.table('Name: ' + i.animal_name + ' / Scientific: ' + i.scientific_name);
});
...
const lowerCase = zooAnimals.map((i) => {return (i.animal_name.toLowerCase())});
...
*/
const largerPopulation = zooAnimals.filter((i) => { return (i.population < 5);});
...
let populationTotal = zooAnimals.reduce((total, representation) => {return total += representation.population;}, 0);
